...
class ViewProfileDetails extends StatefulWidget {
  final ServiceCardData currentItem;
  const ViewProfileDetails({Key key, this.currentItem})
      : super(key: key);
          ...
          child: SafeArea(
            ...
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(widget.currentItem.company_name,
                        style: TextStyle(
                    ...
                    Row(children: [
                      ...
                      Text("(${widget.currentItem.rating.toString()})",
                          style: TextStyle(
                    ...
                    Container(
                      child: Text(widget.currentItem.description,
                    ...
                    Text("Services Names",
                        style: TextStyle(
                            fontSize: 20, fontWeight: FontWeight.w600)),
                    Text(widget.currentItem.services,
                        style: TextStyle(fontSize: 16)),
                    SizedBox(
                      height: 20,
                    ),
                    ...
                    GridView.count(
                      ...
                      children: List.generate(
                        widget.currentItem.portfolio.length,
                        (index) => new Container(
                          width: 100,
                          height: 100,
                          child: Image.network(
